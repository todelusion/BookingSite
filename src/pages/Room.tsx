...
export default function Room() {
  ...
  const onBookingNow = () => {
    if (
      new Date(checkoutModal.startDate).getTime() ===
      new Date(checkoutModal.endDate).getTime()
    ) {
      alert("請選擇退房日");
    } else {
      setCheckoutModal((preState) => {
        return { ...preState, toggleCheckout: true };
      });
    }
  };
        ...
        <section className="pointer-events-none relative flex h-full w-full select-none items-center justify-center">
          <div className="z-10 mt-32">
            ...
            <button
              ...
              className="pointer-events-auto bg-primary py-2 px-14 text-white"
            >
              Booking now
            </button>
          </div>
          ...
          >
            {data.room.map((item: Room) =>
              item.imageUrl.map((image, index) => (
                <SwiperSlide
                  onClick={() =>
                    setSwiperModal({ toggleModal: true, swiperIndex: index })
                  }
            ...
            return (
              <div key={item.id}>
                <p className="mb-5 text-right text-sm font-medium text-primary">
                  {item.descriptionShort.GuestMax} guest．{item.name}．
                  {item.amenities.Breakfast ? "breakfast" : ""}．
                ...
                <ul className="grid max-w-[635px] grid-cols-7 justify-items-center gap-x-9  gap-y-10">
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities.Breakfast ? "block" : "hidden"
                    ...
                    />
                    <p className="absolute -bottom-5 whitespace-nowrap text-center text-xs text-second">
                      早餐
                    </p>
                  </li>
                  <li
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Mini-Bar"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Room-Service"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Wi-Fi"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Child-Friendly"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Television"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Great-View"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Refrigerator"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Sofa"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Pet-Friendly"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Smoke-Free"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Ok"
                      className={`${
                        item.amenities["Air-Conditioner"] ? "block" : "hidden"
                      } absolute -right-5 top-0`}
                    />
                    <img
                      src={Cancel}
