...
import { faAngleRight, faAngleLeft, faAnglesRight, faAnglesLeft, faL } from "@fortawesome/free-solid-svg-icons";
        ...
        /* details.showDatePicker */ true && (
          <div className="w-full max-w-sm rounded-3xl p-8 shadow-xl">
            <div className="flex items-center justify-between">
              {false && <FontAwesomeIcon className="cursor-pointer" icon={faAnglesLeft} onClick={() => setYear(-1)} />}
              <FontAwesomeIcon className="cursor-pointer" icon={faAngleLeft} onClick={() => setMonth(-1)} />
              ...
              <FontAwesomeIcon className="cursor-pointer" onClick={() => setMonth(1)} icon={faAngleRight} />
              {false && <FontAwesomeIcon className="cursor-pointer" icon={faAnglesRight} onClick={() => setYear(1)} />}
            </div>
              ...
              <div className="grid grid-cols-7 justify-items-center">
                ...
                {details.monthDetails?.map((day, index) => (
                  <div
                    ...
                    className={
                      `p-3${day.month !== 0 ? " disabled" : ""}${isCurrentDay(day) ? " highlight" : ""}${
